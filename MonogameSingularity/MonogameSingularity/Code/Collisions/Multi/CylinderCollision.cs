...
namespace Singularity.Code.Collisions.Multi
{
	...
	{
		public CylinderCollision(GameObject parent, float height, float radius) : base(parent)
		{
			...
			this.AddCollisions(
				...
				// add cylinder body
				new BoundEdgeCollision(parent, new Vector3(0, -height/2f, 0), new Vector3(0, height, 0), 1.0f, (scale, distance) => 0 <= scale && scale <= 1),

				// top plane
				new BoundPlaneCollision(parent, new Vector3(0, height / 2f, 0), new Vector3(1, 0, 0), new Vector3(0, 0, 1), circle),
				new BoundPlaneCollision(parent, new Vector3(0, -height / 2f, 0), new Vector3(1, 0, 0), new Vector3(0, 0, 1), circle),

				// seam edges
				new RingCollision(parent, new Vector3(0.0f, height / 2f, 0.0f), new Vector3(1, 0, 0), new Vector3(0, 0, 1), radius, 0.0f),
				new RingCollision(parent, new Vector3(0.0f, -height / 2f, 0.0f), new Vector3(1, 0, 0), new Vector3(0, 0, 1), radius, 0.0f)
