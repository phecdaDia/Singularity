...
namespace Singularity.Helpers
{
	public static class VectorHelper
	{
		...
		public static Vector2 GetScreenPosition(this Vector3 position, Matrix viewMatrix, Matrix projectionMatrix, int screenWidth,
			int screenHeight)
		{
			Vector4 screenPosition = new Vector4(position, 1);
			...
			return new Vector2((screenWidth / 2f) * screenPosition.X + screenWidth / 2f, (screenHeight / 2f) * -screenPosition.Y + screenHeight / 2f);
		}
